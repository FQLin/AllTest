...
namespace ContosoUniversity.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id,byte[] rowVersion)
        {
            ...
            var departmentToUpdate = await this._context.Departments
                .Include(i => i.Adminstrator)
                .SingleOrDefaultAsync(m => m.DepartmentID == id);
            ...
            this._context.Entry(departmentToUpdate).Property(nameof(Department.RowVersion)).OriginalValue = rowVersion;
                ...
                s=>s.Name,s=>s.StartDate,s=>s.Budget,s=>s.InstructorID))
            {
                ...
                catch (DbUpdateConcurrencyException ex)
                {
                    ...
                    else
                    {
                        ...
                        {
                            Instructor databaseInstructor = await this._context.Instructors
