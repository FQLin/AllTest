...
namespace ContosoUniversity.Controllers
{
    public class InstructorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("HireDate,ID,LastName,FirstMidName,OfficeAssignment")] Instructor instructor,
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            this.PopulateAssignedCourseData(instructor);
            return View(instructor);
        }
        ...
        public async Task<IActionResult> Edit(int? id, string[] selectedCourse)
        {
            ...
            var instructorToUpdate = await this._context.Instructors
                .Include(i => i.OfficeAssignment)
                .Include(i => i.CourseAssignments)
                .ThenInclude(i => i.Course)
                .SingleOrDefaultAsync(m=>m.ID==id);
        ...
        {
            var allCourse = this._context.Courses;
        ...
        private void UpdateInstructorCourses(string[] selectCourse, Instructor instructorToUpdate)
        {
            ...
            var selectedCoursesHS=new HashSet<string>(selectCourse);
            var instructorCourses=new HashSet<int>
                (instructorToUpdate.CourseAssignments.Select(c=>c.CourseID));
            foreach (var course in this._context.Courses)
            {
                ...
                else
                {
                    if (instructorCourses.Contains(course.CourseID))
                    {
                        ...
                        this._context.Remove(courseToRemove);
                    }
                }
            }
        }
